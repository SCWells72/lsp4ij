...
| boolean isFormatOnCloseBraceDegradeGracefully(PsiFile file)          | Whether or not to degrade gracefully to the entire file if a more constrained scope cannot be found when formatting on close brace.                                                                                                | `false`                                                |
...
| boolean isFormatOnStatementTerminatorDegradeGracefully(PsiFile file) | Whether or not to degrade gracefully to the code block or entire file if a more constrained scope cannot be found when formatting on statement terminator.                                                                         | `false`                                                |
